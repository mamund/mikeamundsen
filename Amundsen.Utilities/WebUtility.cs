...
namespace Amundsen.Utilities
{
  ...
  public class WebUtility
  {
    ...
    public void SetCompression(HttpContext context)
    {
      ...
      {
        context.Response.Filter = new GZipStream(context.Response.Filter, CompressionMode.Compress,false);
        context.Response.AppendHeader("Content-Encoding", "gzip");
      }
      else if (encodingHeader.Contains("deflate"))
      {
        context.Response.Filter = new DeflateStream(context.Response.Filter, CompressionMode.Compress,false);
